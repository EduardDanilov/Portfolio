...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./contacts-DIuQbOxk.mjs').then((m) => m.default || m)
  },
  {
    name: "document",
    path: "/document",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./document-CR_yawlK.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-C6_YeVCJ.mjs').then((m) => m.default || m)
  },
  {
    name: "rates",
    path: "/rates",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./rates-BakFlQIu.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-UFrUUbwJ.mjs').then((m) => m.default || m)
};
