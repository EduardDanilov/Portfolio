...
***************************************************************************** */
    ...
    lightgallery_es5(document.getElementById("mc-works-gallery"), {
        selector: ".examples-mc__item",
        controls: true,
        mousewheel: true
    });
    lightgallery_es5(document.getElementById("mc-restoration-gallery"), {
        selector: ".examples-mc__item",
        controls: true,
        mousewheel: true
    });
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const carouselMain = new Splide("#main-carousel", {
            cover: true,
            perPage: 1,
            heightRatio: .5,
            type: "loop",
        ...
        const carouselThumbnails = new Splide("#thumbnails-carousel", {
            fixedWidth: 100,
            width: 818,
            fixedHeight: 60,
            gap: 10,
        ...
        carouselMain.sync(carouselThumbnails);
        carouselMain.mount();
        carouselThumbnails.mount();
    }));
    window["FLS"] = true;
    isWebp();
})();