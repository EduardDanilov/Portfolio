<template>
  <div class="center footer">
    ...
    <div class="footer-center">
      <h4 class="footer-nav-heading">Pages</h4>
      <NavList class="footer-navlist" />
    </div>
    <div class="footer-right">
      <h4 class="footer-contacts-heading">Contact</h4>
      <div class="footer-contact-info footer-text-font">
        <p class="contact-adress">
          55 East Birchwood Ave. Brooklyn, New York 11201
        </p>
        <p class="contact-mail">contact@interno.com</p>
...
<script>
import SiteLogo from "../SiteHeader/SiteLogo.vue";
import NavList from "../SiteHeader/NavList.vue";
export default {
  name: "SiteFooter",
  components: { SiteLogo, NavList },
};
</script>
<style scoped>
.footer {
